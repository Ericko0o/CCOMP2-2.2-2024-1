...
void CPartida::ejecutarMovimiento() {
    ...
    if(tablero.posicionValida(posOrigen) and tablero.posicionValida(posDestino)){
        //si las coordenadas estan dentro de los parametros
        cout << endl << "Los valores introducidos son validos.";
        //implementaremos un if else para corroborar que EL movimiento de piezas sea valido desde el posOrigen al posDestino
    /*
